...
import imagesEn, { imageArray } from '../flowerList'
import imagesFr from '../flowerListFr'
...
export default function Game( {locale, props}: {locale: string, props: buttonProps}){



const images = locale == 'en' ? imagesEn : imagesFr
    ...
    <>
      ...
      <section className={finderStyles.flowerhunt}>
        ...
        <section className={finderStyles.resetandRestartWrapper}>
          ...
          <aside className={finderStyles.rrIcon}> <Button onClick={reset}>{props.reset}</Button></aside>
         
          
          <Link className={finderStyles.rrIcon} href='/finder'><Button>{props.start}</Button></Link>
        </section>
